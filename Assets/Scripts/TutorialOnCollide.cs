...
public class TutorialOnCollide : MonoBehaviour
{
    [Header("UI Reference")]
    ...
    public List<TutorialStepp> tutorialStepps;
    ...
    void Start()
    {
        ...
        if (tutorialStepps == null || tutorialStepps.Count == 0)
        {
    ...
    private IEnumerator PlayTutorialSequence()
    {
        ...
        foreach (TutorialStepp step in tutorialStepps)
        {
